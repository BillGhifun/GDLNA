...
- **DLNA/UPnP 协议支持**
  - 实现 UPnP MediaRenderer 设备
  - 支持 SSDP 发现协议（M-SEARCH 响应 & NOTIFY 主动通知）
  - 支持 AVTransport、RenderingControl、ConnectionManager 服务
...
1. 在手机/平板上打开支持 DLNA 的视频应用
2. 选择投屏功能，搜索到 GDLNA 设备
3. 选择要投屏的媒体，GDLNA 会捕获投屏链接
4. 在 Web 界面可以查看、下载或删除投屏链接
